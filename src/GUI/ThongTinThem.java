...
public class ThongTinThem extends javax.swing.JFrame {
    ...
    public ThongTinThem() {
        ...
        card = (CardLayout) panel.getLayout();
         ...
         listncc = new DataLoad().getListNCC();
         listml = new DataLoad().getListMaLoai();
    ...
    private void jLabel5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MousePressed
        ...
        {
        if(new Them().ThemThongTinKhac("NHACUNGCAP",ma,ten))
                {
                    txtmancc.setText("");
                    txttenncc.setText("");
                    LocList();
    ...
    private void jLabel8MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MousePressed
        ...
        {
        if(new Them().ThemThongTinKhac("PHANLOAI",ma,ten))
        {
             txtmaloai.setText("");
             txttenloai.setText("");
             LocList();
...
int mx,my;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThongTinThem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
