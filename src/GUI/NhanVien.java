...
public class NhanVien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(lb);
        lb.setBounds(30, 270, 88, 24);

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 20)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Địa Chỉ");
        jPanel3.add(jLabel3);
        jLabel3.setBounds(30, 370, 65, 24);
        ...
        jPanel3.add(jLabel2);
        jLabel2.setBounds(130, 100, 62, 24);
        ...
        jPanel3.add(jLabel6);
        jLabel6.setBounds(400, 370, 51, 24);
    ...
    private void lbMiniMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbMiniMouseClicked
        this.setExtendedState(NhanVien.ICONIFIED);
    ...
    private void btnLuuMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLuuMousePressed
        // TODO add your handling code here:
        if(new CheckError().KT_SDT(String.valueOf(txtSDT.getText()))==false)
        {
        ...
        if(conf == 0)
        {
            if(new Sua().capnhatTTNV(txtMaNV.getText(), txtHoTen.getText(), String.valueOf(txtGioiTinh.getSelectedItem()), NgaySinh, txtSDT.getText(), txtDiaChi.getText(), txtEmail.getText()))
            {
                Admin.LocListNV();
