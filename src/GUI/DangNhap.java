...
//        } 
    ...
    private void initComponents() {
        ...
        pnDangNhap.setForeground(new java.awt.Color(255, 204, 204));
        ...
        HienMatKhau.setBounds(140, 310, 17, 20);
        ...
        pnDangNhap.setBounds(50, 20, 600, 520);
    ...
    private void txtMatKhauKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtMatKhauKeyReleased
        if(!txtMatKhau.getText().isEmpty() && !txtMatKhau.getText().equals("Mật Khẩu....."))
            lbMatKhau.setText("");
        else {
