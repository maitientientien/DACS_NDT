...
import static GUI.NhanVien.listnv;
...
public class Admin extends javax.swing.JFrame {
    ...
    public static DataLoad load = new DataLoad();
    ...
    tbldsnv.getTableHeader().setForeground(Color.WHITE);
        ...
        listtk = new DataLoad().getListTaiKhoan();
        ...
        listnv = new DataLoad().getListThongTinNhanVien();
    ...
    {
        lbTongNV.setText(String.valueOf(new Tinh().demNV()));
        lbTongSP.setText(String.valueOf(new Tinh().demSP()));
        lbTongHD.setText(String.valueOf(new Tinh().demHD()));
    }
    /**
            ...
            .addGroup(QLTKLayout.createSequentialGroup()
                ...
                .addGroup(QLTKLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, QLTKLayout.createSequentialGroup()
                        ...
                        .addGroup(QLTKLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnChiTiet, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void jLabel14MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MousePressed
        ...
        if(i!=-1)
        {
            ChiTietHoaDonAdmin chitiet = new ChiTietHoaDonAdmin();
    ...
    private void btnThemMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThemMousePressed
        ...
        else
        {
            ...
            else if(new Them().themTK(tk)==false&&conf==0) {
    ...
    private void btnSuaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSuaMousePressed
        ...
        if( i >= 0)
        {
           ...
           if(txtTrangThai.getSelectedItem().equals("Mở"))
            ...
            if(new Sua().suaTK(tkcu, lbTaiKhoan.getText(), lbMatKhau.getText(), lbMaNV.getText(), tttk.getTrangThai()))
            {
                listtk = new DataLoad().getListTaiKhoan();
                modeltk.setRowCount(0);
                for(TAIKHOAN tk : listtk)
